...
#ifndef __ClickC__ModeTwoSceneThree__
#define __ClickC__ModeTwoSceneThree__
...
USING_NS_CC;
using namespace ui;
class ModeTwoSceneThree :public LayerColor
{
public:
    //得到计算结果
    int m_resultsOne = 0;
    ...
    //场景切换
    void changeScene();
    CREATE_FUNC(ModeTwoSceneThree);
    
};

#endif /* defined(__ClickC__ModeTwoSceneThree__) */
