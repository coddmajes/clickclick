...
#ifndef __ClickC__ModeTwo__
#define __ClickC__ModeTwo__
...
USING_NS_CC;
using namespace ui;
class ModeTwoSceneOne :public LayerColor
{
public:
    //得到计算结果
    int m_resultsOne = 0;
    ...
    void changeScene();
    void onExit();
    CREATE_FUNC(ModeTwoSceneOne);
};
#endif /* defined(__ClickC__ModeTwo__) */
